...
const CompletedTaskList: React.FC = React.memo(() => {
  ...
  return (
    <div className="mt-4">
      <h2 className="text-xl font-bold mb-2 text-gray-500">Completed Task</h2>
        ...
        {filteredCompletedTaskItems.map((task: TaskItem, index: number) => (
          ...
          >
            ...
            <div onClick={() => openTaskDetail(task)}>
              <span className="cursor-pointer hover:bg-gray-100 flex-grow mx-2 line-through font-bold">
                {task.title}
              </span>
